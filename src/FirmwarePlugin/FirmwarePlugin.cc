...
const QVariantList& FirmwarePlugin::toolIndicators(const Vehicle*)
{
    ...
    if(_toolIndicatorList.size() == 0) {
      _toolIndicatorList = QVariantList({
          ...
          QVariant::fromValue(
              QUrl::fromUserInput("qrc:/toolbar/GPSIndicator.qml")),
          QVariant::fromValue(
              QUrl::fromUserInput("qrc:/toolbar/TelemetryRSSIIndicator.qml")),
          QVariant::fromValue(
              QUrl::fromUserInput("qrc:/toolbar/RCRSSIIndicator.qml")),
          QVariant::fromValue(
