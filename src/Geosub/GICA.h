...
class GICA : public QObject {
  ...
  Q_PROPERTY(qreal connectionAvailable READ connectionAvailable NOTIFY
  ...
  Q_PROPERTY(
      qreal angularPosRoll READ angularPosRoll NOTIFY angularPosRollChanged)
  Q_PROPERTY(
      qreal angularPosPitch READ angularPosPitch NOTIFY angularPosPitchChanged)
  Q_PROPERTY(qreal angularPosYaw READ angularPosYaw NOTIFY angularPosYawChanged)
  Q_PROPERTY(
      qreal angularVelRoll READ angularVelRoll NOTIFY angularVelRollChanged)
  Q_PROPERTY(
      qreal angularVelPitch READ angularVelPitch NOTIFY angularVelPitchChanged)
  Q_PROPERTY(qreal angularVelYaw READ angularVelYaw NOTIFY angularVelYawChanged)
  Q_PROPERTY(
      qreal angularAccRoll READ angularAccRoll NOTIFY angularAccRollChanged)
  Q_PROPERTY(
      qreal angularAccPitch READ angularAccPitch NOTIFY angularAccPitchChanged)
  ...
  Q_PROPERTY(bool miscSbasCorrection READ miscSbasCorrection NOTIFY
                 miscSbasCorrectionChanged)
...
public:
  ...
  Q_INVOKABLE void toggleGPS(bool enable);
